...
<template>
  <div class="table-pagination">
    <div class="table-pagination__rows hidden">
      Rows per page
      <select class="mr-2" :value="props.pagination_data.row_per_page" @change="methods.handle_change_row_per_page">
        <option>10</option>
        <option>20</option>
        <option>30</option>
      </select>
    ...
    <div class="table-pagination__state" v-if="props.pagination_data.total > 0">
