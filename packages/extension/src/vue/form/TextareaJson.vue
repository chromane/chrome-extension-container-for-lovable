...
import { decode_json } from "@shared/ts/helpers";
...
function handle_input() {
  props.form_state[props.form_field.name] = decode_json(input_ref.value.value);
  input_ref.value.value = JSON.stringify(decode_json(input_ref.value.value), null, "\t");
}
</script>
