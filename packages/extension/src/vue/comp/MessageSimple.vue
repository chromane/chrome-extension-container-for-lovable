...
function get_icon() {
  ...
  } else if (props.model.type === 'failure' || props.model.type === 'negative' || props.model.type === 'error') {
...
<template>
  <div
    ...
    v-bind:class="{
      ...
      'style-negative': props.model.type === 'negative' || props.model.type === 'failure' || props.model.type === 'error',
      'style-warning': props.model.type === 'warning',
      'style-info': props.model.type === 'info',
    }"
  >
    <div class="svg" v-html="get_icon()"></div>
    <div class="details">
      <div class="headline">
        <div v-text="props.model.title"></div>
      </div>
      <div class="body" v-text="props.model.text"></div>
      <div class="action-cont">
        <div class="action" v-for="action in props.model.actions" v-text="action.text" v-on:click="emit('action_click', action)"></div>
      </div>
    </div>
  </div>
</template>
