...
function button_click() {
  if (props.model.status !== 'progress') {
...
<template>
  ...
  >
    ...
    >
      <div class="button-bg" v-if="props.model.color === 'primary' || props.model.color === undefined"></div>
      <div class="button-fg">
        <div class="button-icon" v-if="props.model.icon">
          <div class="chromane-button-spinner" v-if="props.model.status === 'progress'"></div>
          <div class="svg-wrap" v-if="props.model.status !== 'progress'" v-html="props.model.icon"></div>
        </div>
        <div class="button-text" v-text="props.model.text"></div>
      </div>
    </div>
    <div class="button-cover" v-if="props.model.status === 'progress'"></div>
    <div class="button-cover" v-if="props.model.disabled === true"></div>
  </button>
</template>
