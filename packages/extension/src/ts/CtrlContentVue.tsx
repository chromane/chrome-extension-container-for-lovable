...
export default class ContentVue {
  ...
  async init() {
    ...
    document.documentElement.prepend(style2);
    //
    ...
    createRoot(this.container.querySelector('#content-vue-app-root')!).render(<App />);
